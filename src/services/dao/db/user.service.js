...
export default class UserService {
    ...
    uploadFiles = async (req) => {
        try {
            ...
            console.log('Los valid files', validFiles)
            exists.documents.push(...validFiles);
            // exists.documents = [...exists.documents, ...validFiles];
            console.log('los docs pusheados', exists.documents)
            await exists.save();
            console.log('los docs guardados', exists.documents)
